// ============================================================================
// FILE: SupplyRunDry.cs
// PURPOSE: Entry point and state tracker for Dry (ground) resupply missions.
//
// TRIGGERS:
//   - Periodic monitor in Plugin.Update detects a ground unit or structure needing ammunition.
//
// EFFECTS:
...
{
    /// <summary>
    /// Handles Dry (ground unit/structure) resupply scheduling and cooldown tracking.
    /// </summary>
    public static class SupplyRunDry
    {
        ...
        /// <summary>
        /// Triggers an air resupply mission for a ground unit if the unit is off cooldown.
        /// </summary>
        /// <param name="hq">The FactionHQ providing resupply.</param>
        /// <param name="requester">The ground unit needing ammunition.</param>
        public static void SpawnAirResupply(FactionHQ hq, Unit requester)
        {
            ...
            ResupplySpawner.TriggerResupply(hq, requester, isWet: false);
        }
    }
}
