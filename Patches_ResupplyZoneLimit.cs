// ============================================================================
// FILE: Patches_ResupplyZoneLimit.cs
// PURPOSE: Restricts Ibis and Tarantula to only resupply units within their configured thresholds.
//
// TRIGGERS:
//   - Harmony Postfix on AIHeloTransportState.TargetSearch.
//
// EFFECTS:
//   - Clears targetSearchResults.target if the distance exceeds ThresholdA or ThresholdB.
// ============================================================================
