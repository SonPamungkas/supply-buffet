...
- **Paced Launches:** A faction launches at most one transport per `SpawnIntervalSeconds` (default 60 s), so a fleet calling for resupply at once produces a steady stream of deliveries instead of a mass launch.
...
- **Naval & Ground Supply Drops:** Ships are served by Ibis, Tarantula, and Chimera launching from Airbases, Helipads, and Atlas supply ships; ground units and structures are served from any allied airbase.
